...
dataset = load_dataset("enoubi/Twitter-Indonesian-Sarcastic-Fix-Text")

# Ambil data train & test dengan field "tweet" dan "label"
...
def knn_sampling(train_texts, train_labels, test_texts, test_labels, k=5, model_name="firqaaa/indo-sentence-bert-base", output_file="result/knn-twitter.csv"):
    ...
    # Simpan hasil dalam list untuk CSV
    data = []
...
knn_sampling(train_texts, train_labels, test_texts, test_labels, k=7, output_file="result/knn-twitter.csv")
